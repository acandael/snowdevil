      ...
      <div class="md:px-8">
        <CartLines>
          <div className="flex mb-4 w-full">
            <CartLineImage
              ...
              options={{width: 100, height: 100, crop: 'center'}}
            />
        ...
        <div className="flex">
          <input
            ...
            type="text"
            className="border border-black mr-4 p-2 rounded-lg"
            onChange={(event) => setDiscountCode(event.target.value)}
          />
          <button
            onClick={() => addDiscountCode([discountCode])}
            className="bg-black semibold rounded-lg text-white p-4"
          >
            Apply
          </button>
        </div>
        <div className="space-y-2 md:py-5 mb-6">
          ...
          <CartCheckoutButton className="bg-black text-white font-semibold py-4 px-10 rounded-xl w-full">
            Checkout
          </CartCheckoutButton>
        </div>
      </div>
